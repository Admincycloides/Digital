package com.tangentia.junittesting
...
class RegistrationUtilTest {
    ...
    @Test
    fun passwordEmptyReturnFalse()
    {
        val result = RegistrationUtil.validRegistrationInput("username","","")
        assertThat(result).isFalse()
    }
    ...
    {
        val result = RegistrationUtil.validMobileNumber(4544646)
        assertThat(result).isFalse()
    }
